<div class="attachmentsBlocks index">
	<h2><?php echo __('Attachments Blocks'); ?></h2>
	...
	<?php foreach ($attachmentsBlocks as $attachmentsBlock): ?>
	<tr>
		<td><?php echo h($attachmentsBlock['AttachmentsBlock']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $attachmentsBlock['AttachmentsBlock']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $attachmentsBlock['AttachmentsBlock']['id']), null, __('Are you sure you want to delete # %s?', $attachmentsBlock['AttachmentsBlock']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
